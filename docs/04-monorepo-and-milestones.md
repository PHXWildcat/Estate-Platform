...
subsections of `docs/03` — **17** across nine since M40 PR1 re-tagged one of them
to M41 — with TB7 or "the operator platform" named on 15 more
...
was an undercount. It has since moved down once, to seventeen, and not by
measuring — M40 PR1 re-tagged one bullet to M41, an item LEAVING the category
rather than a recount of it.
...
documents oracle to M41 the anchored count is SEVENTEEN while the unanchored one
still answers eighteen, agreeing with the superseded figure for the wrong reason.
...
| # | Milestone | Status |
|---|---|---|
| M21 | TB7 operator platform, minimum slice | **IN PROGRESS.** Approved 2026-08-17, section above. PR0–PR4e shipped; PR5 — documents evidence content plus the legal-hold lift ceremony — is NOT YET SHIPPED, so the milestone is live and its residuals are debt on a live owner (eighteen when M40 PR0 measured; seventeen since M40 PR1 re-tagged §6e's documents oracle to M41). **M40 PR0 corrected what this row was said to be:** the M40 row called its old `**APPROVED**` the same stale-prose defect the M23 row records about itself, and it is the OPPOSITE one — M23 described a finished milestone as in progress; this described a live milestone by saying nothing. They are still a defect, because PR5 does none of them, and that is what the later M40 PRs adjudicate |
