 ...
 *
 * Unlike profile, decrypt takes an actorType: user-facing reads decrypt as
 * 'user'; the projection rebuild decrypts as 'system' so its (deliberately
 * loud) audit trail is distinguishable from real user access.
 */
@Injectable()
